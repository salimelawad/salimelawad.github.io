...
\name{Aaron}{Glover}
\address{1602 Elgin St Apt 14 Houston, TX 77004}
\mobile{281.221.5071}
...
\position{Data Scientist} % Your expertise/fields
\quote{Analytically minded by nature.
Solving complex problems with the simplest solution possible is the desired outcome. \newline
Solid capabilities in modeling, statistical analysis, data munging, and delivering robust data products.}
